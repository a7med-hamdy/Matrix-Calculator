...
class bracketingMethodSolver:
    '''
    params: lower bound / upper bound / tolerance(Es) / function
    returns: lower bound list / upper bound list / number of iterations / root(xr)
    '''
    def bisect(self,a,b,tol,f):
        if f(a)*f(b) >= 0:
            print("no roots here")
            return None
        xr = 0
        ...
        return a_list,b_list,i,xr
    '''
    params: lower bound / upper bound / tolerance(Es) / function
    returns: lower bound list / upper bound list / number of iterations / root(xr)
    '''
    def regula(self,a,b,Es,f):
            upper=0.0
            lower=0.0
            MR1=0.0
            MR2=0.0
            ...
            while(True):
                ...
                lower_List.append(lower)
                if(abs(MR2-MR1)<Es):
                    return lower_List,upper_List,itr,MR2
                else:
                    MR1=MR2
