...
class bracketingMethodSolver:
    ...
    returns: lower bound list / upper bound list / number of iterations / root(xr) / function used
    '''
    def bisect(self,a,b,tol,functionString,n):
        ...
        return list(a_list,b_list,i,xr,f)
    '''
    params: lower bound / upper bound / tolerance(Es) / function / number of significant figures
    returns: lower bound list / upper bound list / number of iterations / root(xr) / function used
    '''
    def regula(self,a,b,tol,functionString,n):
            ...
            while(True):
                ...
                lower_List.append(lower)
                if(abs(MR2-MR1)<tol):
                    return list(lower_List,upper_List,itr,MR2,f)
                else:
                    MR1=MR2
